    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('profilesekolah')}}"><i class="fa fa-circle-o"></i>Tentang Sekolah</a></li>
            <li>
             <a href="{{route('struktur')}}"><i class="fa fa-circle-o"></i>Struktur Organisasi</a>
            </li>
            <li><a href="{{route('visimisi')}}"><i class="fa fa-circle-o"></i>Visi Misi</a></li>
          </ul>
      </li>
      <li>
        <a href="{{route('guru')}}"><span><i class="fa fa-graduation-cap"></i> Daftar Guru</span></a>
      </li>
      <li class="treeview">
          <a href="#">
      ...
      <li>
          <a href="{{route('prestasi')}}">
            <i class="fa fa-users"></i> <span>Prestasi</span>
          </a>
      </li>
       <li>
          <a href="{{route('galeri')}}">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a href="{{route('pengumuman')}}"><i class="fa fa-circle-o"></i>Pengumuman</a></li>
            <li>
             <a href="{{route('berita')}}"><i class="fa fa-circle-o"></i>Berita</a>
            </li>
          </ul>
      </li>
      <li>
