...
<form action="{{route('alumni.post')}}" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" name="thn_lulus" id="thn_lulus" class="form-control" autocomplete="off" required="">
	</div>
	...
	<div class="form-group">
		...
		<input type="text" name="pendidikan_lanjutan" id="pendidikan_lanjutan" autocomplete="off" class="form-control" required="" maxlength="50">
	</div>
